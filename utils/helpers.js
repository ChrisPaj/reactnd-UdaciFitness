...
/* timeToString delivers today`s date as key for the entrie`s object:
store = {
  entries: {
    [timeToString()]: { run: 45, bike: 35, swim: 6671, sleep: 23, eat: 7 },
  }
}; */
...
export function setLocalNotification () {
  AsyncStorage.getItem(NOTIFICATION_KEY)
    .then(JSON.parse)
    .then((data) => {
      // notification does not exist already?
      if (data === null) {
